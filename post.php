...
if (!$post) {
  ...
  <main class="mx-auto max-w-6xl px-5 pb-14 pt-14 md:pt-20">
    <div class="rounded-[2.5rem] bg-white p-10 ring-1 ring-black/10">
      <h1 class="font-['Sora',ui-sans-serif,system-ui] text-3xl font-semibold tracking-tight">Not found</h1>
      <p class="mt-3 text-sm text-zinc-600">This post does not exist or is not published.</p>
      <a href="<?php echo url('blog.php'); ?>" class="mt-6 inline-flex items-center justify-center rounded-full bg-indigo-50 px-5 py-2.5 text-sm font-semibold text-indigo-700 ring-1 ring-indigo-200/60 transition hover:bg-indigo-100">Back to insights</a>
    </div>
  </main>
  <?php
