<section class="mx-auto max-w-6xl px-5 pb-10 pt-14 md:pb-14 md:pt-20 scroll-mt-[5.75rem]">
  <div class="grid gap-10 md:grid-cols-12">
    <div class="md:col-span-6">
      ...
      <h1 class="mt-6 font-['Sora',ui-sans-serif,system-ui] text-4xl font-semibold leading-[1.05] tracking-tight md:text-5xl">Find the truth. Protect what matters.</h1>
      <p class="mt-4 text-base leading-relaxed text-zinc-600">We run discreet investigations with disciplined documentation. From corporate misconduct and due diligence to surveillance and brand protection, our work stays confidential and evidence-led.</p>
      <div class="mt-7 flex flex-col gap-3 sm:flex-row">
        <button type="button" data-open-request class="inline-flex items-center justify-center rounded-full bg-sky-500 px-5 py-2.5 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-sky-600 active:translate-y-0">Request investigation</button>
        <a href="<?php echo url('services.php'); ?>" class="inline-flex items-center justify-center rounded-full bg-indigo-50 px-5 py-2.5 text-sm font-semibold text-indigo-700 ring-1 ring-indigo-200/60 transition hover:bg-indigo-100">All services</a>
      </div>
      <div class="mt-10 grid grid-cols-2 gap-3">
        <div data-reveal class="rounded-2xl bg-sky-50 p-4 ring-1 ring-sky-200/60">
          <div class="text-sm font-semibold">Confidential</div>
          <div class="mt-1 text-xs text-zinc-500">Controlled communications and case access.</div>
        </div>
        <div data-reveal class="rounded-2xl bg-indigo-50 p-4 ring-1 ring-indigo-200/60">
          <div class="text-sm font-semibold">Evidence-led</div>
          <div class="mt-1 text-xs text-zinc-500">Timelines, logs, and structured reporting.</div>
        </div>
      </div>
    </div>
    <div class="md:col-span-6">
        ...
        <div class="relative h-[22rem]">
          ...
          <div class="absolute z-20 bottom-0 p-7">
            <div class="rounded-2xl bg-white/85 p-5 ring-1 ring-black/10 backdrop-blur">
              <div class="text-sm font-semibold">Typical deliverables</div>
