  ...
  <div class="grid gap-8 lg:grid-cols-12 md:gap-10">
    <div class="lg:col-span-7">
      <nav class="flex items-center gap-2 mb-4 text-[12px] font-bold uppercase tracking-[0.2em] text-zinc-400">
        ...
        <span class="text-zinc-600">Our Insights</span>
      </nav>
      ...
      <h1 class="mt-6 font-['Sora',ui-sans-serif,system-ui] text-4xl font-semibold leading-[1.05] tracking-tight md:text-5xl xl:text-6xl">
        Practical guidance for investigations and protection.
      </h1>
    ...
    <div class="lg:col-span-5">
      <div class="lg:mt-12 rounded-[2.5rem] bg-gradient-to-br from-white via-white to-indigo-50/40 p-7 ring-1 ring-black/10 shadow-lg shadow-zinc-600">
        ...
        <button type="button" data-open-request class="cursor-pointer mt-10 inline-flex w-full items-center justify-center rounded-2xl bg-orange-500 px-5 py-3 text-sm xl:text-lg font-semibold text-white transition hover:-translate-y-0.5 hover:bg-orange-600 active:translate-y-0">Request consultation</button>
      </div>
    </div>
  </div>
</section>
