  ...
  <div id="headerContainer" class="w-[90%] mx-auto flex items-center justify-between py-5 transition-all duration-500 ease-in-out">
    <a href="<?php echo ROOT_URL; ?>/" class="flex items-center gap-3 hover:-translate-y-[0.1875rem] transition-all duration-500 ease-in-out">
      ...
      <div class="leading-tight">
        <div class="text-sm font-semibold tracking-wide">Corpsec Investigations & Guarding</div>
    ...
    <nav class="hidden items-center gap-1 lg:flex">
      <a href="<?php echo ROOT_URL; ?>/about" class="inline-flex items-center rounded-xl px-3 py-2 text-sm text-zinc-700 transition hover:bg-sky-50">
      ...
      <div class="relative" data-dropdown>
        <button type="button" data-dropdown-btn aria-expanded="false" aria-controls="servicesMenuDesktop" class="cursor-pointer rounded-xl px-3 py-2 text-sm text-zinc-700 transition hover:bg-sky-50 inline-flex items-center gap-2">
        ...
        <div id="servicesMenuDesktop" data-dropdown-menu class="hidden absolute left-0 mt-2 w-50 rounded-xl bg-white/95 ring-1 ring-black/10 shadow-xl backdrop-blur p-1">
          <a href="<?php echo ROOT_URL; ?>/investigations" class="cursor-pointer block rounded-xl w-full pl-3 py-2 text-sm text-zinc-800 hover:bg-sky-50 transition inline-flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
          ...
          <a href="<?php echo ROOT_URL; ?>/guarding" class="cursor-pointer block rounded-xl w-full pl-3 py-2 text-sm text-zinc-800 hover:bg-sky-50 transition inline-flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
      ...
      <a href="<?php echo ROOT_URL; ?>/insights" class="inline-flex items-center rounded-xl px-3 py-2 text-sm text-zinc-700 transition hover:bg-sky-50">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
      ...
      <a href="<?php echo ROOT_URL; ?>/contact" class="inline-flex items-center rounded-xl px-3 py-2 text-sm text-zinc-700 transition hover:bg-sky-50">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
    ...
    <div class="flex items-center gap-2">
      <button type="button" data-open-request class="cursor-pointer hidden rounded-full bg-orange-500 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:-translate-y-[0.125rem] hover:bg-orange-600 hover:shadow-lg sm:inline-flex transition-all duration-300">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
      ...
      <button id="menuBtn" class="cursor-pointer inline-flex h-10 w-10 items-center justify-center rounded-xl bg-white ring-1 ring-black/10 transition hover:bg-sky-50 lg:hidden">
...
<aside id="sidebar" class="fixed top-0 left-0 z-[10001] h-full w-[17.5rem] -translate-x-full bg-white border-r border-black/10 p-6 transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)]">
  <div class="flex items-center justify-between mb-10">
    <a href="<?php echo ROOT_URL; ?>/" class="flex items-center gap-3 hover:-translate-y-[0.1875rem] transition-all duration-500 ease-in-out">
      ...
      <div class="leading-tight">
        <div class="text-sm font-semibold tracking-wide text-zinc-900">Corpsec Inv.</div>
        <div class="text-xs text-zinc-500 tracking-tighter">Trust But Verify</div>
      </div>
    </a>
  ...
  <nav class="flex flex-col gap-3">
    <a data-sidebar-link href="<?php echo ROOT_URL; ?>/about" class="inline-flex items-center rounded-xl px-3 py-2 text-base text-zinc-700 hover:text-zinc-900 hover:bg-sky-50 transition">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
        <path d="M320 576C461.4 576 576 461.4 576 320C576 178.6 461.4 64 320 64C178.6 64 64 178.6 64 320C64 461.4 178.6 576 320 576zM288 224C288 206.3 302.3 192 320 192C337.7 192 352 206.3 352 224C352 241.7 337.7 256 320 256C302.3 256 288 241.7 288 224zM280 288L328 288C341.3 288 352 298.7 352 312L352 400L360 400C373.3 400 384 410.7 384 424C384 437.3 373.3 448 360 448L280 448C266.7 448 256 437.3 256 424C256 410.7 266.7 400 280 400L304 400L304 336L280 336C266.7 336 256 325.3 256 312C256 298.7 266.7 288 280 288z"/>
      </svg>
      About
    ...
    <div class="rounded-2xl ring-1 ring-black/10 bg-white" data-dropdown>
      ...
      <div id="servicesMenuMobile" data-dropdown-menu class="hidden px-2 pb-2">
        <a data-sidebar-link href="<?php echo ROOT_URL; ?>/investigations" class="flex items-center block rounded-xl px-3 py-2 text-sm text-zinc-700 hover:text-zinc-900 hover:bg-sky-50 transition">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
            <path d="M192 96L224 96C241.7 96 256 110.3 256 128L256 160L160 160L160 128C160 110.3 174.3 96 192 96zM256 192L256 512C256 529.7 241.7 544 224 544L96 544C78.3 544 64 529.7 64 512L64 452.9C64 418.3 73.4 384.3 91.2 354.6C104.9 331.8 113.7 306.4 117 280L124.5 220C126.5 204 140.1 192 156.3 192L256.1 192zM483.8 192C499.9 192 513.6 204 515.6 220L523 280C526.3 306.4 535.1 331.8 548.8 354.6C566.6 384.3 576 418.3 576 452.9L576 512C576 529.7 561.7 544 544 544L416 544C398.3 544 384 529.7 384 512L384 192L483.8 192zM384 128C384 110.3 398.3 96 416 96L448 96C465.7 96 480 110.3 480 128L480 160L384 160L384 128zM352 192L352 352L288 352L288 192L352 192z"/>
          </svg>
          Investigations
        </a>
        <a data-sidebar-link href="<?php echo ROOT_URL; ?>/guarding" class="flex items-center block rounded-xl px-3 py-2 text-sm text-zinc-700 hover:text-zinc-900 hover:bg-sky-50 transition">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
            <path d="M333.4 66.9C329.2 65 324.7 64 320 64C315.3 64 310.8 65 306.6 66.9L118.3 146.8C96.3 156.1 79.9 177.8 80 204C80.5 303.2 121.3 484.7 293.6 567.2C310.3 575.2 329.7 575.2 346.4 567.2C518.8 484.7 559.6 303.2 560 204C560.1 177.8 543.7 156.1 521.7 146.8L333.4 66.9zM224.9 350.2C229.7 351.4 234.8 352 240 352C275.3 352 304 323.3 304 288L304 224L348.2 224C360.3 224 371.4 230.8 376.8 241.7L384 256L448 256C456.8 256 464 263.2 464 272L464 304C464 348.2 428.2 384 384 384L336 384L336 434.7C336 442 330.1 448 322.7 448C320.9 448 319.1 447.6 317.5 446.9L218.8 404.6C212.2 401.8 208 395.3 208 388.2C208 385.4 208.6 382.7 209.9 380.2L224.9 350.2zM224 224L272 224L272 288C272 305.7 257.7 320 240 320C222.3 320 208 305.7 208 288L208 240C208 231.2 215.2 224 224 224zM352 272C352 263.2 344.8 256 336 256C327.2 256 320 263.2 320 272C320 280.8 327.2 288 336 288C344.8 288 352 280.8 352 272z"/>
          </svg>
          Guarding
    ...
    <a data-sidebar-link href="<?php echo ROOT_URL; ?>/insights" class="inline-flex items-center rounded-xl px-3 py-2 text-base text-zinc-700 hover:text-zinc-900 hover:bg-sky-50 transition">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
        <path d="M64 480L64 184C64 170.7 74.7 160 88 160C101.3 160 112 170.7 112 184L112 472C112 485.3 122.7 496 136 496C149.3 496 160 485.3 160 472L160 160C160 124.7 188.7 96 224 96L512 96C547.3 96 576 124.7 576 160L576 480C576 515.3 547.3 544 512 544L128 544C92.7 544 64 515.3 64 480zM224 192L224 256C224 273.7 238.3 288 256 288L320 288C337.7 288 352 273.7 352 256L352 192C352 174.3 337.7 160 320 160L256 160C238.3 160 224 174.3 224 192zM248 432C234.7 432 224 442.7 224 456C224 469.3 234.7 480 248 480L488 480C501.3 480 512 469.3 512 456C512 442.7 501.3 432 488 432L248 432zM224 360C224 373.3 234.7 384 248 384L488 384C501.3 384 512 373.3 512 360C512 346.7 501.3 336 488 336L248 336C234.7 336 224 346.7 224 360zM424 240C410.7 240 400 250.7 400 264C400 277.3 410.7 288 424 288L488 288C501.3 288 512 277.3 512 264C512 250.7 501.3 240 488 240L424 240z"/>
      </svg>
      Insights
    ...
    <a data-sidebar-link href="<?php echo ROOT_URL; ?>/contact" class="inline-flex items-center rounded-xl px-3 py-2 text-base text-zinc-700 hover:text-zinc-900 hover:bg-sky-50 transition">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
        <path d="M224.2 89C216.3 70.1 195.7 60.1 176.1 65.4L170.6 66.9C106 84.5 50.8 147.1 66.9 223.3C104 398.3 241.7 536 416.7 573.1C493 589.3 555.5 534 573.1 469.4L574.6 463.9C580 444.2 569.9 423.6 551.1 415.8L453.8 375.3C437.3 368.4 418.2 373.2 406.8 387.1L368.2 434.3C297.9 399.4 241.3 341 208.8 269.3L253 233.3C266.9 222 271.6 202.9 264.8 186.3L224.2 89z"/>
      </svg>
      Contact
    ...
    <button type="button" data-open-request class="cursor-pointer w-full rounded-xl bg-orange-500 px-4 py-3 text-sm font-semibold text-white shadow-sm hover:-translate-y-[0.125rem] hover:bg-orange-600 hover:shadow-lg inline-flex items-center transition-all duration-500 ease-in-out">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" fill="currentColor" class="h-5 w-5 mr-1">
        <path d="M320 128C241 128 175.3 185.3 162.3 260.7C171.6 257.7 181.6 256 192 256L208 256C234.5 256 256 277.5 256 304L256 400C256 426.5 234.5 448 208 448L192 448C139 448 96 405 96 352L96 288C96 164.3 196.3 64 320 64C443.7 64 544 164.3 544 288L544 456.1C544 522.4 490.2 576.1 423.9 576.1L336 576L304 576C277.5 576 256 554.5 256 528C256 501.5 277.5 480 304 480L336 480C362.5 480 384 501.5 384 528L384 528L424 528C463.8 528 496 495.8 496 456L496 435.1C481.9 443.3 465.5 447.9 448 447.9L432 447.9C405.5 447.9 384 426.4 384 399.9L384 303.9C384 277.4 405.5 255.9 432 255.9L448 255.9C458.4 255.9 468.3 257.5 477.7 260.6C464.7 185.3 399.1 127.9 320 127.9z"/>
      </svg>
      Request consultation
